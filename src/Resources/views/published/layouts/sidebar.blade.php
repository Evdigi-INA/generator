                            ...
                            @foreach ($sidebar['menus'] as $menu)
                                ...
                                @canany($permissions)
                                    @if (empty($menu['submenus']))
                                        ...
                                        @endcan
                                    @else
                                        <li class="sidebar-item has-sub{{  Zzzul\Generator\Generators\GeneratorUtils::isActiveMenu($menu['permissions']) }}">
                                                ...
                                                @canany($menu['permissions'])
                                                    @foreach ($menu['submenus'] as $submenu)
                                                        @can($submenu['permission'])
                                                            <li class="submenu-item{{  Zzzul\Generator\Generators\GeneratorUtils::isActiveMenu($submenu['route']) }}">
