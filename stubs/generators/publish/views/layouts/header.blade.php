...
<head>
    ...
    <title>@yield('title') - {{ env(key: 'APP_NAME') }}</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="shortcut icon" href="{{ asset(path: 'mazer') }}/compiled/svg/favicon.svg" type="image/x-icon" />
...
<body>
    <script src="{{ asset(path: 'mazer') }}/static/js/initTheme.js"></script>
    <div id="app">
                            ...
                            <ul class="navbar-nav ms-auto mb-lg-0">
                                <li class="nav-item dropdown me-1">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li><a class="dropdown-item{{ config(key: 'app.locale') == 'id' ? ' active' : '' }}"
                                                href="#">{{ __(key: 'Indonesia') }}</a></li>
                                        <li><a class="dropdown-item{{ config(key: 'app.locale') == 'en' ? ' active' : '' }}"
                            ...
                            @auth
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route(name: 'profile') }}"><i
                                        ...
                                        <li>
                                            ...
                                            <form id="logout-form-nav" action="{{ route(name: 'logout') }}" method="POST"
                                                class="d-none">
                                                @csrf
                                            </form>
                                        </li>
